...
set outmain /scratch/users/wyen/task5_0913_XFrame; # change here
# set outmain trial;

# Some constants
set g 386.1;
set col_drift 0.10;
set num_stories 44; # change here
set num_piers 4; # change here
set num_bays 3; # change here
set TmaxAnalysis [expr 5*60]; # five minute maximum

# Source procedures
set userdirectory [pwd]

source $userdirectory/BuildBRBMaterial.tcl;
source $userdirectory/rotSpring2DModIKModel.tcl;
...
dict for {serial gminfo} $gminfo_dict {
    if {[expr {$serial % $numprocs}] == $this_procid} {
        dict with gminfo {
            ...
            source $userdirectory/XFrame.tcl;
